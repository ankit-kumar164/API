...
> This retrieves the auth token for kumar

curl -X POST -F 'username=kumar1' -F 'password=123456' http://localhost:8000/api-token-auth/

http post http://localhost:8000/api-token-auth/ username=kumar password=123456


> This will retrieve all items

curl -X GET -H 'Authorization: Token 791c6bf14699f62ddb4b08ab9a2ca3ad9e3a5fc3' http://localhost:8000/post/

http http://localhost:8000/post/ 'Authorization: Token 3b6ca12db3049304dfa44a45001e1df2eec039a3'


> This will retreive a single item

curl -X GET -H 'Authorization: Token 8c1174dc40dad1b027c804268dcfca3cc934c9a5' http://api:8000/item/5e658d49-8109-4237-878c-e32bbe48745b/

http http://localhost:8000/post/452f5f76-5f8b-484d-a990-1fd264415c26/ 'Authorization: Token 3b6ca12db3049304dfa44a45001e1df2eec039a3' 

> This retrieve all orders

curl -X GET -H 'Authorization: Token 8c1174dc40dad1b027c804268dcfca3cc934c9a5' http://api:8000/order/

http http://api:8000/order/ 'Authorization: Token 8c1174dc40dad1b027c804268dcfca3cc934c9a5'

> This will place an order for item id = 5e658d49-8109-4237-878c-e32bbe48745b quantity = 1

curl -X POST -H 'Content-Type: application/json' -H 'Authorization: Token 8c1174dc40dad1b027c804268dcfca3cc934c9a5' -d '{"item": "5e658d49-8109-4237-878c-e32bbe48745b", "quantity": "1"}' http://api:8000/order/

http http://api:8000/order/ 'Authorization: Token 8c1174dc40dad1b027c804268dcfca3cc934c9a5' item="5e658d49-8109-4237-878c-e32bbe48745b" quantity="1"


> This get order id = **your_order_uuid**

curl -X GET -H 'Authorization: Token 8c1174dc40dad1b027c804268dcfca3cc934c9a5' http://api:8000/order/**your_order_uuid**/

http http://api:8000/order/8a4b0e31-7a4a-4f11-a24b-5273dfeff8b5/ 'Authorization: Token 8c1174dc40dad1b027c804268dcfca3cc934c9a5'
