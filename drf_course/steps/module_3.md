...
curl -X POST -H "Content-type: application/json" -d '{"id_user": "2", "bio": "test", "location":"new jersey"}' 'http://api:8000/contact/'

http http://localhost:8000/contact/ id_user="2" bio="test" location="new jersey"
