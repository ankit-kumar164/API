...
curl -X POST -F 'username=kumar' -F 'password=123456' http://api:8000/api-token-auth/

http post http://api:8000/api-token-auth/ username=kumar password=123456


> This will retrieve all items

curl -X GET -H 'Authorization: Token 8c1174dc40dad1b027c804268dcfca3cc934c9a5' http://api:8000/item/

http http://api:8000/item/ 'Authorization: Token 8c1174dc40dad1b027c804268dcfca3cc934c9a5'
...
http http://api:8000/item/5e658d49-8109-4237-878c-e32bbe48745b/ 'Authorization: Token 8c1174dc40dad1b027c804268dcfca3cc934c9a5' 
